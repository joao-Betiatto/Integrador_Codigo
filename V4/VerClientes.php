    ...
    <div class="menu">
        <nav class="navigation-menu">
            ...
            <ul class="list-nav">
                ...
                <li class="item-nav">
                    <a class="link-nav" href="Cli/VerClientes.php">
...
$squad = $_SESSION['squad'];
        $comando = $pdo->prepare('SELECT * FROM Clientesss where squad = :squad');
        ...
        #    exit; 
        #}        
                        echo "<h1> Clientes: </h1> <font color = #000000> <background-color= #ffffff> <table border = 2> <tr> <td>Projeto</td> <td>Deal</td> <td>CNPJ</td> <td>Stakeholder</td> <td>CPF Stakeholder</td> <td>telefone</td> <td>email</td> <td>Squad</td> </tr> ";                                                                                                
                        foreach($resultado as $linha) {
                            echo "<tr> <td>". $linha['projeto']. "</td> <td> ". $linha['deal']. "</td><td>". $linha['cnpj']. "</td><td>". $linha['stakeholder']. "</td><td>". $linha['cpf']. "</td><td>". $linha['telefone']. "</td><td>". $linha['email']. "</td><td>". $linha['squad']. "</td>"." </tr>";
                        }
                        echo "</table>";
            ?>